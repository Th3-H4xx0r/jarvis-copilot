...
# ============================================================================
# Mini-SWE Runner with JarvisCopilot Trajectory Format
# ============================================================================
...
class MiniSWERunner:
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to JarvisCopilot trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to JarvisCopilot trajectory format
...
def main(
    ...
    """
    Run SWE tasks with JarvisCopilot trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with JarvisCopilot Trajectory Format")
    print("=" * 60)
