...
private:
    std::atomic<bool> input_highpass_{false};
    float hp_b0_ = 0, hp_b1_ = 0, hp_b2_ = 0, hp_a1_ = 0, hp_a2_ = 0;
    float hp_x1_ = 0, hp_x2_ = 0, hp_y1_ = 0, hp_y2_ = 0;
    void HighPass(std::vector<int16_t>& data, int channels);
