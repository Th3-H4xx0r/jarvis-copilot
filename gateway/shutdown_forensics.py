...
def check_systemd_timing_alignment(drain_timeout: float) -> Optional[Dict[str, Any]]:
    ...
    upgraded jarviscopilot but never re-ran ``jarviscopilot setup`` to regenerate
    ...
    try:
        # /proc/self/cgroup gives us "0::/user.slice/.../jarviscopilot-gateway.service"
    ...
    # that's the common case for jarviscopilot.
    ...
    # constant in jarviscopilot_cli/gateway.py.
    headroom = 30.0
