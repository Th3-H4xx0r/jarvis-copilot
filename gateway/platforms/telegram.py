...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def _thread_kwargs_for_send(
        ...
        metadata. JarvisCopilot-created private-chat topic lanes are marked with
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "To recover: ensure no other JarvisCopilot or OpenClaw instance is running "
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            # readable by the JarvisCopilot process (shared mount, same machine, etc.).
            ...
            try:
                ...
                from jarviscopilot_cli.commands import telegram_menu_commands
    ...
    # Scripts live in ~/.jarviscopilot/scripts/gmail-triage/. `arg` from the callback
    ...
    def _explicit_bot_mentions_exclude_self(self, message: Message) -> bool:
        ...
        Telegram groups can contain several JarvisCopilot bot profiles. A message like
