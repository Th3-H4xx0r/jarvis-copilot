...
#   - cli.py, jarviscopilot_cli/*      -> inline on startup (no event loop)
...
def get_tool_definitions(
    ...
    if quiet_mode:
        try:
            from jarviscopilot_cli.config import get_config_path
...
_AGENT_LOOP_TOOLS = {"todo", "memory", "session_search", "delegate_task", "tool_search"}
