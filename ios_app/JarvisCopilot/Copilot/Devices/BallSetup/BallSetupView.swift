...
/// Done button once the ball is online.
struct BallSetupView: View {
    ...
    private var subline: String {
        ...
        if flow.statuses[.wifi] == .active { return "The ball joins this network to reach Jarvis." }
        return "Keep the ball close to your phone."
    }
    ...
    private var tips: some View {
        GlassCard(padding: 18) {
            VStack(alignment: .leading, spacing: 14) {
                ...
                tip("waveform", "Say \u{201C}Jarvis\u{201D}, or tap the ball, and ask anything.")
    ...
    private func detailText(_ step: BallSetupFlow.Step, _ status: BallSetupFlow.Status) -> String? {
        ...
        case (.send, .active): return "Sending to the ball…"
        default: return nil
        }
    }
