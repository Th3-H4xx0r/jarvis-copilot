...
# jarviscopilot modules.  jarviscopilot_cli sets HERMES_PYTHON_SRC_ROOT before spawning this
...
# ``jarviscopilot --tui``) imports cleanly there.  SIGBREAK (Windows' Ctrl+Break)
