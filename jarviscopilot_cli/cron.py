"""
Cron subcommand for jarviscopilot CLI.
...
def cron_list(show_all: bool = False):
    ...
    if not jobs:
        ...
        print(color("Create one with 'jarviscopilot cron create ...' or the /cron command in chat.", Colors.DIM))
        return
    ...
    if not find_gateway_pids():
        ...
        print(color("     Start it with: jarviscopilot gateway install", Colors.DIM))
        print(color("                    sudo jarviscopilot gateway install --system  # Linux servers", Colors.DIM))
        print()
...
def cron_status():
    ...
    if pids:
        ...
        print("    jarviscopilot gateway install    # Install as a user service")
        print("    sudo jarviscopilot gateway install --system  # Linux servers: boot-time system service")
        print("    jarviscopilot gateway            # Or run in foreground")
...
def cron_command(args):
    ...
    print("Usage: jarviscopilot cron [list|create|edit|pause|resume|run|remove|status|tick]")
    sys.exit(1)
