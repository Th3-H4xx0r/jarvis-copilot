...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("update", "Update JarvisCopilot Agent to the latest version", "Info"),
...
Telegram only displays a small BotCommand menu in practice.  The full JarvisCopilot
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append(("hermes", "Talk to JarvisCopilot or run a subcommand", "[subcommand] [args]"))
    seen.add("hermes")
