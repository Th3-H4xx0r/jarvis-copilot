...
Invoked by ``jarviscopilot kanban decompose [task_id | --all]`` and the
...
* Mirrors the shape of ``jarviscopilot_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the JarvisCopilot board.
...
def _profile_author() -> str:
    """Mirror of ``jarviscopilot_cli.kanban._profile_author``."""
    return (
