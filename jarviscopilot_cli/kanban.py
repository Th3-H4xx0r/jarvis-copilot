"""CLI for the JarvisCopilot Kanban board — ``hermes kanban …`` subcommand.
...
from jarviscopilot_cli import kanban_swarm as ks
from jarviscopilot_cli.profiles import get_active_profile_name, get_profile_dir, seed_profile_skills
