...
TIPS = [
    ...
    "hermes mcp serve runs JarvisCopilot itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire JarvisCopilot home directory.",
    ...
    "hermes gateway install sets up JarvisCopilot as a system service (systemd/launchd).",
    ...
    "JarvisCopilot loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs JarvisCopilot as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    'hermes dashboard --tui embeds the full JarvisCopilot TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'hermes chat --ignore-user-config skips ~/.jarviscopilot/config.yaml — reproducible bug reports and CI runs.',
