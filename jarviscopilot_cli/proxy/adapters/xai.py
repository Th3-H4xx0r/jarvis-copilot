...
# xAI's public API is OpenAI-compatible for the endpoints JarvisCopilot commonly
# uses. The Responses endpoint is included because JarvisCopilot' native xAI runtime
...
class XAIGrokAdapter(UpstreamAdapter):
    """Proxy upstream for xAI Grok via JarvisCopilot-managed OAuth credentials."""
