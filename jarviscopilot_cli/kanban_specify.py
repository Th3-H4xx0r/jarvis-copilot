...
Used by ``jarviscopilot kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``jarviscopilot_cli/goals.py`` — same aux
...
def _profile_author() -> str:
    """Mirror of ``jarviscopilot_cli.kanban._profile_author``. Kept local to
