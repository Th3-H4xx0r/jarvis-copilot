...
DEFAULT_CODEX_MODELS: List[str] = [
    ...
    # in jarviscopilot_cli/models.py — only the openai-codex (OAuth) provider
...
_FORWARD_COMPAT_TEMPLATE_MODELS: List[tuple[str, tuple[str, ...]]] = [
    ...
    # entitlement; JarvisCopilot does not.
...
def _read_cache_models(codex_home: Path) -> List[str]:
    ...
    if isinstance(entries, list):
        for item in entries:
            ...
            # public OpenAI API, while JarvisCopilot openai-codex talks to the same
