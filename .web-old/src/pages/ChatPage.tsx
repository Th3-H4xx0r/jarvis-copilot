 ...
 *          ▼                                                              .
 *     FastAPI pty_ws  (jarviscopilot_cli/web_server.py)                          .
 *          ▼                                                              .
...
export default function ChatPage({ isActive = true }: { isActive?: boolean }) {
  ...
  useEffect(() => {
    ...
    const term = new Terminal({
      ...
      // even when the inner JarvisCopilot TUI has enabled xterm mouse-events
    ...
    // forwarding them into JarvisCopilot. Keyboard input, paste, and resize still
    // behave normally.
