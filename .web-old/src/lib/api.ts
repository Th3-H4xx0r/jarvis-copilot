...
const SESSION_HEADER = "X-JarvisCopilot-Session-Token";
...
async function getSessionToken(): Promise<string> {
  ...
  throw new Error("Session token not available — page must be served by the JarvisCopilot dashboard server");
}
