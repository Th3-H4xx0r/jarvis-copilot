...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateHermes: "JarvisCopilot frissítése",
    updatingHermes: "JarvisCopilot frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      "JarvisCopilot-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `hermes plugins` paritás).",
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.jarviscopilot/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.jarviscopilot/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.jarviscopilot/skills/ mappából töltődnek be",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gyűjthető JarvisCopilot-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",
      scan_subtitle:
        "JarvisCopilot munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a JarvisCopilot kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "A JarvisCopilot egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
