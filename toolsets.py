...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "enable in `jarviscopilot tools` → X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    },
    ...
    "video_gen": {
        "description": (
            ...
            "``jarviscopilot tools`` → Video Generation."
        ),
    ...
    "memory": {
        "description": "Persistent memory across sessions (personal notes + user profile, plus reference photos of people)",
        "tools": ["memory", "visual_memory"],
        "includes": []
    },
    ...
    # ==========================================================================
    # Full JarvisCopilot toolsets (CLI + messaging platforms)
    #
    ...
    "hermes-cron": {
        ...
        # core tools users see interactively — then `jarviscopilot tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as hermes-cli; gated by `jarviscopilot tools`",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-email": {
        "description": "Email bot toolset - interact with JarvisCopilot via email (IMAP/SMTP)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-sms": {
        "description": "SMS bot toolset - interact with JarvisCopilot via SMS (Twilio)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
