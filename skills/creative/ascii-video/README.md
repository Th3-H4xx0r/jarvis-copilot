...
Built for [JarvisCopilot](https://github.com/NousResearch/jarviscopilot). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/jarviscopilot/skills/creative/ascii-video`](https://github.com/NousResearch/jarviscopilot/tree/main/skills/creative/ascii-video) via PR.
