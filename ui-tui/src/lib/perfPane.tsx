...
//
// Both gate on HERMES_DEV_PERF=1 and dump JSON-lines (default ~/.jarviscopilot/perf.log,
...
import type { FrameEvent } from '@jarviscopilot/ink'
import { scrollFastPathStats } from '@jarviscopilot/ink'
...
const LOG_PATH = process.env.HERMES_DEV_PERF_LOG?.trim() || join(homedir(), '.jarviscopilot', 'perf.log')
