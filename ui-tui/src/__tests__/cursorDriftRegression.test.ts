 ...
 *
 * Symptom: in `jarviscopilot --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@jarviscopilot/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using jarviscopilot --tui and as i type multiline my caret at the end will often ' +
