...
describe('forceTruecolor', () => {
  ...
  it('respects existing FORCE_COLOR unless JarvisCopilot truecolor is explicit', async () => {
    await withCleanEnv(
      () => {
  ...
  it('lets explicit JarvisCopilot truecolor override existing FORCE_COLOR', async () => {
    await withCleanEnv(
      () => {
