...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Bundled skills (shipped with JarvisCopilot, e.g. 'hermes-agent').\n"
    ...
    try:
        with open(os.devnull, "w", encoding="utf-8") as _devnull, \
            ...
            if state_override and state_override.get("own_store"):
                ...
                _own = _MemoryStore(
                    memory_char_limit=getattr(agent._memory_store, "memory_char_limit", 0),
                    user_char_limit=getattr(agent._memory_store, "user_char_limit", 0),
                )
                _own.load_from_disk()
