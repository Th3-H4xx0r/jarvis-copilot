...
# outside that subset before sending JarvisCopilot tool schemas to Google.
...
def sanitize_gemini_schema(schema: Any) -> Dict[str, Any]:
    ...
    JarvisCopilot tool schemas are OpenAI-flavored JSON Schema and may contain keys
