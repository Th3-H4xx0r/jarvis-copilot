"""Anthropic Messages API adapter for JarvisCopilot Agent.
...
def resolve_anthropic_token() -> Optional[str]:
    ...
    # 1. JarvisCopilot-managed OAuth/setup token env var
...
# ── JarvisCopilot-native PKCE OAuth flow ────────────────────────────────────────
...
def run_hermes_oauth_login_pure() -> Optional[Dict[str, Any]]:
    """Run JarvisCopilot-native OAuth PKCE flow and return credential state."""
    import secrets
    import time
    import webbrowser
...
def read_hermes_oauth_credentials() -> Optional[Dict[str, Any]]:
    """Read JarvisCopilot-managed OAuth credentials from ~/.jarviscopilot/.anthropic_oauth.json."""
