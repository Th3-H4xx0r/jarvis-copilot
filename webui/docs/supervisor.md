# Running JarvisCopilot Web UI under a process supervisor
...
<dict>
    ...
    <string>/Users/yourname/.jarviscopilot/webui/launchd-stdout.log</string>

    <key>StandardErrorPath</key>
    <string>/Users/yourname/.jarviscopilot/webui/launchd-stderr.log</string>
...
```ini
[Unit]
Description=JarvisCopilot Web UI
...
JarvisCopilot Web UI exposes two health levels:
...
- ``/health?deep=1`` — readiness probe that briefly acquires the stream lock,
  reads the sidebar/session path, reads projects state, and touches JarvisCopilot
