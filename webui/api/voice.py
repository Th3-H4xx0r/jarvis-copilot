...
_VOICE_REPLY_DIRECTIVE = (
    ...
    "conversation needs no tool. The user's phone, watch, water bottle, scale "
    "and boards are device_<skill> tools; if the tool for a device is not "
    "present, that device is not connected right now — say exactly that. Never "
    "substitute Shortcuts, shell commands or scripts for a missing device tool.\n"
