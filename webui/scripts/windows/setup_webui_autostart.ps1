...
$description = "Auto-start JarvisCopilot WebUI inside WSL at Windows logon. Runs $WslScriptPath."
...
if ($PSCmdlet.ShouldProcess($TaskName, "Register Windows Scheduled Task for JarvisCopilot WebUI WSL autostart")) {
