...
Users with older jarviscopilot versions (missing 'source' column in state.db) got
...
class TestCliSessionsErrorSurface:
    ...
    def test_missing_source_column_suggests_upgrade(self):
        """Warning message must suggest upgrading jarviscopilot."""
        assert "Upgrade jarviscopilot" in combined_src or "upgrade jarviscopilot" in combined_src.lower()
