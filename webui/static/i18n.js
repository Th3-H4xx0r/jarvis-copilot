...
const LOCALES = {
  en: {
    ...
    offline_network_detail: 'JarvisCopilot is unreachable from this browser right now.',
    offline_autorefresh: 'I will refresh this page automatically when JarvisCopilot is reachable again.',
    ...
    mcp_restart_hint: 'Server changes are read-only here for now. Edit config.yaml and restart JarvisCopilot for changes to take effect.',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" may not work with your configured provider (${p}). Send anyway, or run \`jarviscopilot model\` in your terminal to switch.`,
    ...
    cmd_skills: 'List available JarvisCopilot skills',
  ...
  status_agent_running:'Agent running',
    ...
    status_hermes_home: 'JarvisCopilot home',
  ...
  untitled:'Untitled',
    no_personalities: 'No personalities found (add them to ~/.jarviscopilot/personalities/)',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_section_preferences_meta: 'Defaults and UI behavior for JarvisCopilot Web UI.',
    ...
    settings_plugins_meta: 'View installed JarvisCopilot plugins and the lifecycle hooks they register. This panel is read-only.',
    settings_plugins_empty: 'No JarvisCopilot plugins are currently visible. Install or enable plugins from the JarvisCopilot CLI/config to see them here.',
    ...
    project_name_prompt: 'Project name:',
    // Sidebar & Tabs
    settings_label_personality: 'Personality',
    settings_personality_help: 'Style of every response. Applies to both chat and voice. Takes effect on the next message.',
    settings_label_voice_providers: 'Voice Providers (TTS)',
    settings_voice_providers_help: 'Enable engines for the Voice tab. Cloud engines need an API key. Fish Audio also needs a voice ID pasted from fish.audio.',
    voice_label_engine: 'Engine',
    voice_err_no_session: 'Open a chat session first so voice has somewhere to talk.',
    voice_btn_done_speaking: 'Done speaking',
    voice_btn_interrupt: 'Interrupt',
    tab_chat: 'Chat',
    tab_voice: 'Voice',
    tab_tasks: 'Tasks',
    tab_integrations: 'Integrations',
    intg_new: 'New integration',
    intg_none: 'No integrations yet. Ask Jarvis for one, or create it here.',
    intg_empty_title: 'Select an integration',
    intg_empty_sub: 'Each one owns its schedules, the data it keeps and the skills written for it.',
    tab_skills: 'Skills',
    tab_memory: 'Memory',
    ...
    voice_mode_hint_quality: 'Hold the button to speak, release to send.',
    voice_mode_hint_realtime: 'Stream your voice live. Lower latency, conversational feel.',
    voice_status_idle: 'Ready',
    ...
    voice_label_voice: 'Voice',
    voice_label_tts_test: 'Test TTS',
    ...
    voice_footer_hint: 'Audio is processed on your JarvisCopilot agent. STT & TTS providers are configured in JarvisCopilot settings.',
    voice_err_no_mic: 'Microphone access denied or unavailable.',
    voice_err_stt_unavailable: 'Speech-to-text is unavailable on this server.',
    voice_err_tts_unavailable: 'Text-to-speech is unavailable on this server.',
    voice_err_ws_failed: 'Realtime connection failed.',
    voice_err_no_speech: "Didn't catch that — try again.",
    kanban_board: 'Board',
    ...
    kanban_work_queue_hint: 'This is the JarvisCopilot Agent work queue. Create or triage a task, assign it, move it to Ready, then let the dispatcher claim it.',
    ...
    kanban_assignee_profiles_label: 'JarvisCopilot profiles',
    ...
    tab_dashboard: 'JarvisCopilot Dashboard',
    ...
    insights_messages_title: 'Messages (this conversation)',
    insights_messages_no_session: 'Open a conversation to see its per-message token breakdown.',
    insights_messages_empty: 'No messages recorded yet.',
    insights_composition: 'Composition',
    insights_details: 'Details',
    insights_cache_hit: 'cached',
    insights_est_note: 'Input composition is estimated (~chars ÷ 4); the in/out totals are exact from the API.',
    insights_reasoning: 'Reasoning',
    ...
    settings_desc_voice_mode: 'Show the voice-mode button (audio waveform) next to the dictation mic. Lets you speak naturally — JarvisCopilot auto-sends after a pause and reads replies aloud. Requires a browser that supports both speech recognition and TTS.',
    ...
    settings_desc_sync_insights: 'Mirrors WebUI token usage to state.db so jarviscopilot /insights includes browser session data. Off by default.',
    ...
    settings_desc_bot_name: 'Display name for the assistant throughout the UI. Defaults to JarvisCopilot.',
    ...
    providers_oauth_config_yaml_hint: 'Token configured via config.yaml. To update, edit the providers section in your config.yaml or run jarviscopilot auth.',
    providers_oauth_not_configured_hint: 'Not authenticated. Run jarviscopilot auth in the terminal to configure this provider.',
    providers_save: 'Save',
    ...
    onboarding_title: 'Welcome to JarvisCopilot Web UI',
    onboarding_lead: 'A quick guided setup will verify JarvisCopilot, save a real provider configuration, choose a workspace and model, and optionally protect the app with a password.',
    onboarding_back: 'Back',
    onboarding_continue: 'Continue',
    onboarding_skip: 'Skip setup',
    onboarding_skipped: 'Setup skipped — using existing config.',
    onboarding_open: 'Open JarvisCopilot',
    onboarding_step_system_title: 'System check',
    onboarding_step_system_desc: 'Verify JarvisCopilot Agent and config visibility.',
    onboarding_step_setup_title: 'Provider setup',
    onboarding_step_setup_desc: 'Save the minimum JarvisCopilot provider config.',
    ...
    onboarding_notice_system_ready: 'JarvisCopilot Agent looks reachable from the Web UI.',
    onboarding_notice_system_unavailable: 'JarvisCopilot Agent is not fully available yet. Bootstrap can install it, but provider setup may still require a terminal.',
    onboarding_check_agent: 'JarvisCopilot Agent',
    ...
    onboarding_notice_setup_required: 'Choose a simple provider path here. Advanced OAuth flows still belong in the JarvisCopilot CLI for now.',
    onboarding_notice_setup_already_ready: 'A working JarvisCopilot provider setup is already detected. You can keep it or replace it here.',
    onboarding_oauth_provider_ready_title: 'Provider already authenticated',
    onboarding_oauth_provider_ready_body: 'This instance is configured to use an OAuth provider (<strong>{provider}</strong>) that was set up via the JarvisCopilot CLI. No API key is needed here — click Continue to finish setup.',
    onboarding_oauth_provider_not_ready_title: 'OAuth provider not yet authenticated',
    onboarding_oauth_provider_not_ready_body: 'This instance is configured to use <strong>{provider}</strong>, which uses OAuth rather than an API key. Run <code>jarviscopilot auth</code> or <code>jarviscopilot model</code> in a terminal to authenticate, then reload the Web UI.',
    ...
    onboarding_api_key_help_prefix: 'Saved as a secret in your JarvisCopilot .env file using',
    ...
    onboarding_workspace_help: 'Pick the model JarvisCopilot should use for new chats after setup completes.',
  ...
  it: {
    ...
    offline_network_detail: 'JarvisCopilot non è raggiungibile da questo browser al momento.',
    offline_autorefresh: 'Aggiornerò automaticamente la pagina quando JarvisCopilot sarà di nuovo raggiungibile.',
    ...
    mcp_restart_hint: 'Le modifiche ai server sono in sola lettura qui. Modifica config.yaml e riavvia JarvisCopilot per applicare le modifiche.',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" potrebbe non funzionare con il provider configurato (${p}). Invia comunque, o esegui \`jarviscopilot model\` nel terminale per cambiare.`,
    ...
    cmd_skills: 'Elenca le skill JarvisCopilot disponibili',
  ...
  status_agent_running:'Agente in esecuzione',
    ...
    status_hermes_home: 'Home JarvisCopilot',
  ...
  untitled:'Senza titolo',
    no_personalities: 'Nessuna personalità trovata (aggiungile in ~/.jarviscopilot/personalities/)',
  ...
  folder_add_as_space_title: 'Aggiungere come Spazio?',
    ...
    settings_section_preferences_meta: 'Predefiniti e comportamento UI per JarvisCopilot Web UI.',
    ...
    settings_plugins_meta: 'View installed JarvisCopilot plugins and the lifecycle hooks they register. This panel is read-only.',  // TODO: translate
    settings_plugins_empty: 'No JarvisCopilot plugins are currently visible. Install or enable plugins from the JarvisCopilot CLI/config to see them here.',  // TODO: translate
    ...
    kanban_work_queue_hint: 'Questa è la coda di lavoro di JarvisCopilot Agent. Crea o classifica un task, assegnalo, spostalo in Pronto, poi lascia che il dispatcher lo reclami.',
    ...
    kanban_assignee_profiles_label: 'Profili JarvisCopilot',
    ...
    tab_todos: 'Todos',
    tab_insights: 'Insights',
    tab_dashboard: 'Dashboard JarvisCopilot',
    ...
    settings_desc_sync_insights: 'Rispecchia l\'uso token WebUI su state.db così jarviscopilot /insights include i dati delle sessioni browser. Disattivato per impostazione predefinita.',
    ...
    settings_desc_whats_new_summary: "Changes the What's New action from opening the raw diff first to generating a short, human-readable summary. The regular diff comparison stays available after the summary.",
    settings_desc_bot_name: 'Nome visualizzato per l\'assistente in tutta l\'interfaccia. Predefinito: JarvisCopilot.',
    ...
    providers_oauth_config_yaml_hint: 'Token configurato via config.yaml. Per aggiornare, modifica la sezione providers in config.yaml o esegui jarviscopilot auth.',
    providers_oauth_not_configured_hint: 'Non autenticato. Esegui jarviscopilot auth nel terminale per configurare questo provider.',
    ...
    onboarding_title: 'Benvenuto in JarvisCopilot Web UI',
    onboarding_lead: 'Una configurazione guidata rapida verificherà JarvisCopilot, salverà una configurazione provider reale, sceglierà un workspace e un modello e opzionalmente proteggerà l\'app con una password.',
    ...
    onboarding_open: 'Apri JarvisCopilot',
    onboarding_step_system_title: 'Verifica sistema',
    onboarding_step_system_desc: 'Verifica JarvisCopilot Agent e visibilità configurazione.',
    onboarding_step_setup_title: 'Configurazione provider',
    onboarding_step_setup_desc: 'Salva la configurazione minima provider JarvisCopilot.',
    ...
    onboarding_notice_system_ready: 'JarvisCopilot Agent sembra raggiungibile dalla Web UI.',
    onboarding_notice_system_unavailable: 'JarvisCopilot Agent non è ancora completamente disponibile. Bootstrap può installarlo, ma la configurazione provider potrebbe richiedere un terminale.',
    onboarding_check_agent: 'JarvisCopilot Agent',
    ...
    onboarding_notice_setup_required: 'Scegli un percorso provider semplice qui. I flussi OAuth avanzati rimangono nella CLI di JarvisCopilot per ora.',
    onboarding_notice_setup_already_ready: 'Una configurazione provider JarvisCopilot funzionante è già stata rilevata. Puoi mantenerla o sostituirla qui.',
    onboarding_oauth_provider_ready_title: 'Provider già autenticato',
    onboarding_oauth_provider_ready_body: 'Questa istanza è configurata per usare un provider OAuth (<strong>{provider}</strong>) impostato tramite la CLI di JarvisCopilot. Nessuna chiave API necessaria — clicca Continua per finire.',
    onboarding_oauth_provider_not_ready_title: 'Provider OAuth non ancora autenticato',
    onboarding_oauth_provider_not_ready_body: 'Questa istanza è configurata per usare <strong>{provider}</strong>, che usa OAuth invece di una chiave API. Esegui <code>jarviscopilot auth</code> o <code>jarviscopilot model</code> in un terminale per autenticarti, poi ricarica la Web UI.',
    ...
    onboarding_api_key_help_prefix: 'Salvato come segreto nel tuo file .env di JarvisCopilot usando',
    ...
    onboarding_workspace_help: 'Scegli il modello che JarvisCopilot userà per le nuove chat dopo la configurazione.',
  ...
  ja: {
    ...
    offline_network_detail: '現在、このブラウザからJarvisCopilotに到達できません。',
    offline_autorefresh: 'JarvisCopilotに再接続できたら、このページを自動的に更新します。',
    ...
    mcp_restart_hint: 'ここでのサーバー変更は現状読み取り専用です。反映するには config.yaml を編集して JarvisCopilot を再起動してください。',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" は設定されたプロバイダ (${p}) で動作しない可能性があります。このまま送信するか、ターミナルで \`jarviscopilot model\` を実行して切り替えてください。`,
    ...
    cmd_skills: '利用可能な JarvisCopilot スキルを一覧表示',
  ...
  status_agent_running:'エージェント実行中',
    ...
    status_hermes_home: 'JarvisCopilot ホーム',
    status_started: '開始',
    status_tokens: 'トークン',
    status_updated: '更新',
  ...
  untitled:'無題',
    no_personalities: 'パーソナリティが見つかりません (~/.jarviscopilot/personalities/ に追加してください)',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    settings_section_preferences_meta: 'JarvisCopilot Web UI のデフォルトと UI 動作。',
    ...
    kanban_work_queue_hint: 'これは JarvisCopilot Agent のワークキューです。タスクを作成またはトリアージし、担当者を割り当て、Ready に移動すると、ディスパッチャーがそれをクレームします。',
    ...
    kanban_assignee_profiles_label: 'JarvisCopilot プロファイル',
    ...
    tab_todos: 'ToDo',
    tab_insights: 'インサイト',
    tab_dashboard: 'JarvisCopilot ダッシュボード',
    ...
    settings_desc_sync_insights: 'WebUI のトークン使用量を state.db にミラーし、jarviscopilot /insights にブラウザセッションのデータを含めます。デフォルトはオフ。',
    settings_desc_check_updates: 'WebUI または Agent の新しいバージョンが利用可能な時にバナーを表示します。バックグラウンドで定期的に git fetch を実行します。',
    settings_desc_whats_new_summary: "Changes the What's New action from opening the raw diff first to generating a short, human-readable summary. The regular diff comparison stays available after the summary.",
    settings_desc_bot_name: 'UI 全体で表示されるアシスタントの名前。デフォルトは JarvisCopilot。',
    ...
    providers_oauth_config_yaml_hint: 'config.yaml でトークンが設定されています。更新するには config.yaml の providers セクションを編集するか jarviscopilot auth を実行してください。',
    providers_oauth_not_configured_hint: '未認証です。ターミナルで jarviscopilot auth を実行してこのプロバイダを設定してください。',
    providers_save: '保存',
    providers_remove: '削除',
    ...
    onboarding_lead: 'クイックガイドで JarvisCopilot を確認し、プロバイダ設定を保存し、ワークスペースとモデルを選択し、必要ならパスワードでアプリを保護します。',
    onboarding_back: '戻る',
    onboarding_continue: '続ける',
    onboarding_skip: 'セットアップをスキップ',
    onboarding_skipped: 'セットアップをスキップ — 既存設定を使用します。',
    onboarding_open: 'JarvisCopilot を開く',
    onboarding_step_system_title: 'システム確認',
    onboarding_step_system_desc: 'JarvisCopilot Agent と設定の可視性を確認します。',
    onboarding_step_setup_title: 'プロバイダ設定',
    onboarding_step_setup_desc: '最低限の JarvisCopilot プロバイダ設定を保存します。',
    ...
    onboarding_notice_system_ready: 'Web UI から JarvisCopilot Agent へ到達できそうです。',
    onboarding_notice_system_unavailable: 'JarvisCopilot Agent はまだ完全には利用できません。Bootstrap でインストールできますが、プロバイダ設定にはターミナルが必要な場合があります。',
    onboarding_check_agent: 'JarvisCopilot Agent',
    ...
    onboarding_notice_setup_required: 'シンプルなプロバイダ経路をここで選んでください。高度な OAuth フローは現状 JarvisCopilot CLI 側で扱います。',
    onboarding_notice_setup_already_ready: '動作する JarvisCopilot プロバイダ設定が既に検出されています。維持するか、ここで置き換えできます。',
    onboarding_oauth_provider_ready_title: 'プロバイダは認証済み',
    onboarding_oauth_provider_ready_body: 'このインスタンスは JarvisCopilot CLI で設定された OAuth プロバイダ (<strong>{provider}</strong>) を使用します。APIキーは不要 — 続けるをクリックしてセットアップを完了してください。',
    onboarding_oauth_provider_not_ready_title: 'OAuth プロバイダは未認証',
    onboarding_oauth_provider_not_ready_body: 'このインスタンスは <strong>{provider}</strong> を使用しますが、これは APIキー ではなく OAuth を使用します。ターミナルで <code>jarviscopilot auth</code> または <code>jarviscopilot model</code> を実行して認証し、Web UI を再読み込みしてください。',
    ...
    onboarding_api_key_help_prefix: 'JarvisCopilot の .env ファイルにシークレットとして保存されます — 使用変数:',
    ...
    onboarding_workspace_help: 'セットアップ完了後の新規チャットで JarvisCopilot が使用するモデルを選択してください。',
    onboarding_custom_model_placeholder: 'your-model-name',
  ...
  ru: {
    ...
    offline_network_detail: 'JarvisCopilot сейчас недоступен из этого браузера.',
    offline_autorefresh: 'Я автоматически обновлю страницу, когда JarvisCopilot снова станет доступен.',
    ...
    `"${m}" может не работать с вашим настроенным провайдером (${p}). Всё равно отправить или запустите \`jarviscopilot model\` в терминале, чтобы переключиться.`,
    ...
    cmd_skills: 'Показать доступные навыки JarvisCopilot',
    ...
    no_personalities: 'Личности не найдены (добавьте их в ~/.jarviscopilot/personalities/)',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    kanban_assignee_profiles_label: 'Профили JarvisCopilot',
    ...
    tab_dashboard: 'Панель JarvisCopilot',
    ...
    settings_desc_sync_insights: 'Синхронизирует использование токенов WebUI в state.db, чтобы JarvisCopilot /insights включал данные браузерных сеансов. Выключено по умолчанию.',
    ...
    settings_desc_whats_new_summary: "Changes the What's New action from opening the raw diff first to generating a short, human-readable summary. The regular diff comparison stays available after the summary.",
    settings_desc_bot_name: 'Отображаемое имя помощника во всём интерфейсе. По умолчанию JarvisCopilot.',
    ...
    onboarding_lead: 'Краткая пошаговая настройка проверит JarvisCopilot, сохранит рабочую конфигурацию провайдера, выберет рабочее пространство и модель и при желании защитит приложение паролем.',
    ...
    onboarding_open: 'Открыть JarvisCopilot',
    onboarding_step_system_title: 'Проверка системы',
    onboarding_step_system_desc: 'Проверить JarvisCopilot Agent и видимость конфигурации.',
    onboarding_step_setup_title: 'Настройка провайдера',
    onboarding_step_setup_desc: 'Сохранить минимальную рабочую конфигурацию провайдера JarvisCopilot.',
    ...
    onboarding_notice_system_ready: 'JarvisCopilot Agent, похоже, доступен из Web UI.',
    onboarding_notice_system_unavailable: 'JarvisCopilot Agent ещё не полностью доступен. Bootstrap может установить его, но для настройки провайдера всё ещё может понадобиться терминал.',
    onboarding_check_agent: 'JarvisCopilot Agent',
    ...
    onboarding_notice_setup_required: 'Выберите здесь простой путь настройки провайдера. Продвинутые OAuth-сценарии пока остаются в JarvisCopilot CLI.',
    onboarding_notice_setup_already_ready: 'Уже обнаружена рабочая конфигурация провайдера JarvisCopilot. Вы можете оставить её или заменить здесь.',
    onboarding_oauth_provider_ready_title: 'Провайдер уже авторизован',
    onboarding_oauth_provider_ready_body: 'Этот экземпляр настроен на использование OAuth-провайдера (<strong>{provider}</strong>), настроенного через JarvisCopilot CLI. API-ключ здесь не нужен — нажмите «Продолжить», чтобы завершить настройку.',
    onboarding_oauth_provider_not_ready_title: 'OAuth-провайдер ещё не авторизован',
    onboarding_oauth_provider_not_ready_body: 'Этот экземпляр настроен на использование <strong>{provider}</strong>, который работает через OAuth, а не через API-ключ. Запустите <code>jarviscopilot auth</code> или <code>jarviscopilot model</code> в терминале, чтобы пройти авторизацию, затем обновите Web UI.',
    ...
    onboarding_api_key_help_prefix: 'Сохраняется как секрет в вашем файле `.env` JarvisCopilot с помощью',
    ...
    onboarding_workspace_help: 'Выберите модель, которую JarvisCopilot должен использовать для новых чатов после завершения настройки.',
    ...
    settings_desc_voice_mode: 'Показывать кнопку голосового режима (аудиоволны) рядом с микрофоном диктовки. JarvisCopilot автоматически отправляет реплики после паузы и зачитывает ответы вслух. Требуется браузер с поддержкой распознавания речи и TTS.',
  ...
  es: {
    ...
    offline_network_detail: 'JarvisCopilot no está disponible desde este navegador ahora mismo.',
    offline_autorefresh: 'Actualizaré esta página automáticamente cuando JarvisCopilot vuelva a estar disponible.',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" puede no funcionar con tu proveedor configurado (${p}). Envía de todas formas, o ejecuta \`jarviscopilot model\` en la terminal para cambiar.`,
    ...
    cmd_skills: 'Listar las skills de JarvisCopilot disponibles',
    ...
    no_personalities: 'No se encontraron personalidades (añádelas a ~/.jarviscopilot/personalities/)',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    kanban_assignee_profiles_label: 'Perfiles JarvisCopilot',
    ...
    tab_dashboard: 'Panel de JarvisCopilot',
    ...
    settings_desc_sync_insights: 'Refleja el uso de tokens de la WebUI en state.db para que jarviscopilot /insights incluya datos de sesiones del navegador. Desactivado por defecto.',
    ...
    settings_desc_whats_new_summary: "Changes the What's New action from opening the raw diff first to generating a short, human-readable summary. The regular diff comparison stays available after the summary.",
    settings_desc_bot_name: 'Nombre visible del asistente en toda la UI. Por defecto es JarvisCopilot.',
    ...
    onboarding_title: 'Bienvenido a JarvisCopilot Web UI',
    onboarding_lead: 'Una guía rápida verificará JarvisCopilot, guardará una configuración real del proveedor, elegirá un espacio de trabajo y un modelo, y opcionalmente protegerá la app con una contraseña.',
    ...
    onboarding_open: 'Abrir JarvisCopilot',
    onboarding_step_system_title: 'Comprobación del sistema',
    onboarding_step_system_desc: 'Verifica JarvisCopilot Agent y la visibilidad de la configuración.',
    onboarding_step_setup_title: 'Configuración del proveedor',
    onboarding_step_setup_desc: 'Guarda la configuración mínima real de JarvisCopilot.',
    ...
    onboarding_notice_system_ready: 'Parece que JarvisCopilot Agent está accesible desde la Web UI.',
    onboarding_notice_system_unavailable: 'JarvisCopilot Agent todavía no está totalmente disponible. Bootstrap puede instalarlo, pero la configuración del proveedor quizá aún requiera una terminal.',
    onboarding_check_agent: 'JarvisCopilot Agent',
    ...
    onboarding_notice_setup_required: 'Elige aquí una ruta simple de proveedor. Los flujos OAuth avanzados siguen siendo del CLI de JarvisCopilot por ahora.',
    onboarding_notice_setup_already_ready: 'Ya se detectó una configuración funcional del proveedor de JarvisCopilot. Puedes conservarla o reemplazarla aquí.',
    onboarding_oauth_provider_ready_title: 'Proveedor ya autenticado',
    onboarding_oauth_provider_ready_body: 'Esta instancia está configurada para usar un proveedor OAuth (<strong>{provider}</strong>) configurado mediante la CLI de JarvisCopilot. No se necesita clave API aquí — haz clic en Continuar para finalizar la configuración.',
    onboarding_oauth_provider_not_ready_title: 'Proveedor OAuth no autenticado aún',
    onboarding_oauth_provider_not_ready_body: 'Esta instancia está configurada para usar <strong>{provider}</strong>, que utiliza OAuth en lugar de una clave API. Ejecuta <code>jarviscopilot auth</code> o <code>jarviscopilot model</code> en una terminal para autenticarte y recarga la interfaz web.',
    ...
    oauth_codex_error: 'OAuth login failed', // TODO: translate
    oauth_codex_expired: 'Code expired, please try again', // TODO: translate
    onboarding_api_key_help_prefix: 'Se guarda como secreto en tu archivo .env de JarvisCopilot usando',
    onboarding_base_url_label: 'Base URL',
    ...
    onboarding_workspace_help: 'Elige el modelo que JarvisCopilot debe usar para nuevos chats cuando termine la configuración.',
    ...
    settings_desc_voice_mode: 'Show the voice-mode button (audio waveform) next to the dictation mic. Lets you speak naturally — JarvisCopilot auto-sends after a pause and reads replies aloud. Requires a browser that supports both speech recognition and TTS.',  // TODO: translate
  ...
  de: {
    ...
    offline_network_detail: 'JarvisCopilot ist von diesem Browser aus gerade nicht erreichbar.',
    offline_autorefresh: 'Ich aktualisiere diese Seite automatisch, sobald JarvisCopilot wieder erreichbar ist.',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" funktioniert möglicherweise nicht mit Ihrem konfigurierten Provider (${p}). Trotzdem senden, oder \`jarviscopilot model\` im Terminal ausführen.`,
    ...
    no_personalities: 'Keine Persönlichkeiten gefunden (füge sie in ~/.jarviscopilot/personalities/ hinzu)',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    settings_desc_sync_insights: 'Spiegelt den WebUI-Token-Verbrauch in die state.db, sodass jarviscopilot /insights Browser-Sitzungsdaten enthält. Standardmäßig aus.',
    ...
    settings_desc_whats_new_summary: "Changes the What's New action from opening the raw diff first to generating a short, human-readable summary. The regular diff comparison stays available after the summary.",
    settings_desc_bot_name: 'Anzeigename für den Assistenten in der UI. Standardmäßig JarvisCopilot.',
    ...
    onboarding_title: 'Willkommen bei JarvisCopilot',
    ...
    onboarding_step_system_desc: 'JarvisCopilot Agent muss installiert und erreichbar sein.',
    ...
    onboarding_notice_system_unavailable: 'Agent nicht erreichbar. Bitte starten Sie JarvisCopilot Agent.',
  ...
  zh: {
    ...
    offline_network_detail: '此浏览器当前无法连接到 JarvisCopilot。',
    offline_autorefresh: '当 JarvisCopilot 可访问时，我会自动刷新此页面。',
    ...
    mcp_restart_hint: '服务器更改目前为只读。请编辑 config.yaml 并重启 JarvisCopilot。',
    ...
    provider_mismatch_warning: (m,p)=>`\"${m}\" 可能无法在当前配置的提供商 (${p}) 下工作。直接发送，或在终端运行 \`jarviscopilot model\` 切换。`,
    ...
    cmd_skills: '列出可用的 JarvisCopilot 技能',
    ...
    settings_plugins_meta: '查看已安装的 JarvisCopilot 插件及其注册的生命周期挂钩。此面板为只读。',
    settings_plugins_empty: '当前没有可见的 JarvisCopilot 插件。通过 JarvisCopilot CLI/配置文件安装或启用插件后即可在此查看。',
    ...
    no_personalities: '没有找到人设（可添加到 ~/.jarviscopilot/personalities/）',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    tab_integrations: '集成',
    intg_new: '新建集成',
    intg_none: '还没有集成。可以让 Jarvis 创建，或在此新建。',
    intg_empty_title: '选择一个集成',
    intg_empty_sub: '每个集成拥有自己的计划任务、数据和技能。',
    tab_kanban: '看板',
    kanban_board: '看板',
    ...
    kanban_work_queue_hint: '这是 JarvisCopilot Agent 的工作队列。创建或分类任务，分配任务，将其移至“就绪”状态，然后让调度员认领任务。',
    ...
    kanban_assignee_profiles_label: 'JarvisCopilot 配置',
    ...
    tab_todos: '待办',
    tab_insights: '统计',
    tab_dashboard: 'JarvisCopilot 仪表盘',
    ...
    providers_oauth_config_yaml_hint: '通过 config.yaml 配置的令牌。如需更新，请编辑 config.yaml 中的 providers 部分或运行 jarviscopilot auth。',
    providers_oauth_not_configured_hint: '未认证。在终端中运行 jarviscopilot auth 以配置此提供商。',
    providers_save: '保存',
    providers_remove: '移除',
    providers_saving: '保存中…',
    ...
    settings_desc_sync_insights: '将 WebUI token 使用情况同步到 state.db，使 jarviscopilot /insights 包含浏览器会话数据。默认关闭。',
    settings_desc_check_updates: '当有更新的 WebUI 或助手版本时显示横幅。会在后台定期执行 git fetch。',
    settings_desc_whats_new_summary: "Changes the What's New action from opening the raw diff first to generating a short, human-readable summary. The regular diff comparison stays available after the summary.",
    settings_desc_bot_name: '助手在 UI 中的显示名称。默认为 JarvisCopilot。',
    ...
    onboarding_lead: '快速引导将验证 JarvisCopilot、保存真实的提供商配置、选择工作区和模型，并可选设置密码保护应用。',
    onboarding_back: '返回',
    onboarding_continue: '继续',
    onboarding_skip: '跳过设置',
    onboarding_skipped: '设置已跳过 — 使用现有配置。',
    onboarding_open: '打开 JarvisCopilot',
    onboarding_step_system_title: '系统检查',
    onboarding_step_system_desc: '验证 JarvisCopilot Agent 与配置可见性。',
    onboarding_step_setup_title: '提供商设置',
    onboarding_step_setup_desc: '保存最小可用的 JarvisCopilot 提供商配置。',
    ...
    onboarding_notice_system_ready: 'JarvisCopilot Agent 看起来可从 Web UI 访问。',
    onboarding_notice_system_unavailable: 'JarvisCopilot Agent 尚未完全可用。Bootstrap 可以安装它，但提供商设置可能仍需要终端。',
    onboarding_check_agent: 'JarvisCopilot Agent',
    ...
    onboarding_notice_setup_required: '请先在此选择一个简单的提供商路径。高级 OAuth 流程暂时仍建议在 JarvisCopilot CLI 中完成。',
    onboarding_notice_setup_already_ready: '已检测到可用的 JarvisCopilot 提供商配置。你可以保留它，或在这里替换。',
    onboarding_oauth_provider_ready_title: '提供商已完成认证',
    onboarding_oauth_provider_ready_body: '此实例已配置为使用通过 JarvisCopilot CLI 设置的 OAuth 提供商（<strong>{provider}</strong>）。这里不需要 API key，点击继续即可完成设置。',
    onboarding_oauth_provider_not_ready_title: 'OAuth 提供商尚未认证',
    onboarding_oauth_provider_not_ready_body: '此实例已配置为使用 <strong>{provider}</strong>，该提供商使用 OAuth 而非 API key。请在终端运行 <code>jarviscopilot auth</code> 或 <code>jarviscopilot model</code> 完成认证，然后重新加载 Web UI。',
    ...
    onboarding_api_key_help_prefix: '会作为密钥保存到 JarvisCopilot .env 文件中，变量名为',
    onboarding_base_url_label: 'Base URL',
    onboarding_base_url_placeholder: 'https://your-endpoint.example/v1',
    onboarding_base_url_help: '用于 OpenAI 兼容路由、自托管服务、LiteLLM、Ollama、LM Studio、vLLM 或类似端点。',
    onboarding_model_label: '默认模型',
    onboarding_workspace_help: '选择设置完成后 JarvisCopilot 在新聊天中使用的模型。',
    onboarding_custom_model_placeholder: 'your-model-name',
    ...
    settings_section_preferences_meta: 'JarvisCopilot WebUI 的默认和 UI 行为。',
    ...
    status_profile: '配置文件',
    status_hermes_home: 'JarvisCopilot 主目录',
    status_started: '开始时间',
    status_tokens: '令牌',
    status_unknown: '未知',
    cmd_yolo: 'YOLO 模式切换',
    ...
    settings_desc_voice_mode: '在听写麦克风旁显示语音模式按钮（音频波形）。让您自然说话 — JarvisCopilot 会在停顿后自动发送并朗读回复。需要支持语音识别和 TTS 的浏览器。',
  ...
  'zh-Hant': {
    ...
    provider_mismatch_warning: (m,p)=>`\"${m}\" \u53ef\u80fd\u7121\u6cd5\u5728\u7576\u524d\u914d\u7f6e\u7684\u63d0\u4f9b\u8005 (${p}) \u4e0b\u904b\u4f5c\u3002\u5c1a\u9001\uff0c\u6216\u5728\u7d42\u7aef\u57f7\u884c \`jarviscopilot model\` \u5207\u63db\u3002`,
    ...
    workspace_hidden_files_visible_title: 'Hidden files are visible — click for options',
    workspace_options: 'Workspace options',
    no_personalities: '\u6c92\u6709\u627e\u5230\u4eba\u8a2d\uff08\u53ef\u6dfb\u52a0\u5230 ~/.jarviscopilot/personalities/\uff09',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    settings_section_preferences_meta: 'JarvisCopilot Web UI 的預設值與介面行為。',
    ...
    settings_plugins_meta: '檢視已安裝的 JarvisCopilot 外掛及其註冊的生命週期鉤子。此面板為唯讀。',
    settings_plugins_empty: '目前沒有可見的 JarvisCopilot 外掛。透過 JarvisCopilot CLI/設定檔安裝或啟用外掛後即可在此檢視。',
    ...
    tab_todos: '待辦',
    tab_insights: '統計',
    tab_dashboard: 'JarvisCopilot 儀表板',
    ...
    kanban_work_queue_hint: '這是 JarvisCopilot Agent 的工作佇列。建立或分類任務、指派對象、移至 Ready，然後讓調度器認領。',
    ...
    kanban_assignee_profiles_label: 'JarvisCopilot 設定檔',
    ...
    settings_desc_sync_insights: '將 WebUI token 使用情況同步到 state.db，使 jarviscopilot /insights 包含瀏覽器會話數據。預設未啟用。',
    ...
    jump_to_question: '回到問題',
    jump_to_question_label: '跳至這則回答對應的問題',
    onboarding_api_key_help_prefix: '\u900f\u904e\u4ee5\u4e0b\u65b9\u5f0f\u5132\u5b58\u70ba JarvisCopilot .env \u6a94\u6848\u4e2d\u7684\u6a5f\u5bc6',
    ...
    onboarding_lead: '\u5feb\u901f\u9010\u6b65\u8a2d\u5b9a\uff1a\u6aa2\u67e5 JarvisCopilot\u3001\u5132\u5b58\u63d0\u4f9b\u8005\u914d\u7f6e\u3001\u9078\u64c7\u5de5\u4f5c\u5340\u8207\u6a21\u578b\uff0c\u4e26\u53ef\u9078\u64c7\u52a0\u5165\u5bc6\u78bc\u4fdd\u8b77\u3002',
    ...
    onboarding_notice_setup_already_ready: '\u5df2\u5075\u6e2c\u5230\u53ef\u7528\u7684 JarvisCopilot \u63d0\u4f9b\u8005\u914d\u7f6e\u3002\u60a8\u53ef\u4ee5\u4fdd\u7559\u6216\u5728\u6b64\u53d6\u4ee3\u3002',
    onboarding_notice_setup_required: '\u5728\u6b64\u9078\u64c7\u5feb\u901f\u63d0\u4f9b\u8005\u8a2d\u5b9a\u8def\u5f91\u3002\u9032\u968e OAuth \u8a2d\u5b9a\u4ecd\u8acb\u4f7f\u7528 JarvisCopilot CLI\u3002',
    onboarding_notice_system_ready: 'JarvisCopilot Agent \u53ef\u5f9e Web UI \u5b58\u53d6\u3002',
    onboarding_notice_system_unavailable: 'JarvisCopilot Agent \u5c1a\u672a\u5b8c\u5168\u53ef\u7528\u3002\u5f15\u5c0e\u7a0b\u5f0f\u53ef\u80fd\u5b89\u88dd\u5b83\uff0c\u4f46\u63d0\u4f9b\u8005\u8a2d\u5b9a\u53ef\u80fd\u4ecd\u9700\u7d42\u7aef\u6a5f\u3002',
    onboarding_notice_workspace: '\u9019\u4e9b\u503c\u4f7f\u7528\u8207\u4e00\u822c\u61c9\u7528\u7a0b\u5f0f\u76f8\u540c\u7684\u8a2d\u5b9a API\u3002',
    onboarding_oauth_provider_not_ready_body: '\u6b64\u5be6\u4f8b\u8a2d\u5b9a\u4f7f\u7528 <strong>{provider}</strong>\uff0c\u5b83\u4f7f\u7528 OAuth \u800c\u975e API \u91d1\u9470\u3002\u8acb\u5728\u7d42\u7aef\u6a5f\u4e2d\u57f7\u884c <code>jarviscopilot auth</code> \u6216 <code>jarviscopilot model</code> \u9032\u884c\u6388\u6b0a\uff0c\u7136\u5f8c\u91cd\u65b0\u6574\u7406 Web UI\u3002',
    onboarding_oauth_provider_not_ready_title: 'OAuth \u63d0\u4f9b\u8005\u5c1a\u672a\u6388\u6b0a',
    onboarding_oauth_provider_ready_body: '\u6b64\u5be6\u4f8b\u8a2d\u5b9a\u4f7f\u7528\u900f\u904e JarvisCopilot CLI \u914d\u7f6e\u7684 OAuth \u63d0\u4f9b\u8005\uff08<strong>{provider}</strong>\uff09\u3002\u7121\u9700 API \u91d1\u9470 \u2014 \u6309\u7e7c\u7e8c\u5b8c\u6210\u8a2d\u5b9a\u3002',
    onboarding_oauth_provider_ready_title: '\u63d0\u4f9b\u8005\u5df2\u6388\u6b0a',
    onboarding_oauth_switch_hint: '\u6216\u9078\u64c7\u4e0b\u65b9\u5176\u4ed6\u63d0\u4f9b\u8005\u4ee5\u5207\u63db\u5230 API \u91d1\u9470\u8a2d\u5b9a\uff1a',
    onboarding_open: '\u958b\u555f JarvisCopilot',
    ...
    onboarding_step_setup_desc: '\u5132\u5b58\u6700\u5c0f\u53ef\u7528\u7684 JarvisCopilot \u63d0\u4f9b\u8005\u914d\u7f6e\u3002',
    onboarding_step_setup_title: '\u63d0\u4f9b\u8005\u8a2d\u5b9a',
    onboarding_step_system_desc: '\u9a57\u8b49 JarvisCopilot Agent \u8207\u914d\u7f6e\u53ef\u898b\u6027\u3002',
    onboarding_step_system_title: '\u7cfb\u7d71\u6aa2\u67e5',
    onboarding_step_workspace_desc: '\u70ba\u65b0\u6703\u8a71\u9078\u64c7\u9810\u8a2d\u503c\u3002',
    onboarding_step_workspace_title: '\u5de5\u4f5c\u5340\u8207\u6a21\u578b',
    onboarding_title: '\u6b61\u8fce\u4f7f\u7528 JarvisCopilot Web UI',
    onboarding_unknown: '\u672a\u77e5',
    onboarding_workspace_help: '\u9078\u64c7 JarvisCopilot \u5728\u8a2d\u5b9a\u5b8c\u6210\u5f8c\u7528\u65bc\u65b0\u804a\u5929\u5ba4\u7684\u6a21\u578b\u3002',
    ...
    providers_oauth_config_yaml_hint: '\u5df2\u900f\u904e config.yaml \u8a2d\u5b9a\u6b0a\u8b49\u3002\u8981\u66f4\u65b0\uff0c\u8acb\u7de8\u8f2f config.yaml \u4e2d\u7684 providers \u5340\u6bb5\uff0c\u6216\u57f7\u884c jarviscopilot auth\u3002',
    providers_oauth_not_configured_hint: '\u5c1a\u672a\u9a57\u8b49\u3002\u8acb\u5728\u7d42\u7aef\u6a5f\u57f7\u884c jarviscopilot auth \u4ee5\u8a2d\u5b9a\u6b64\u63d0\u4f9b\u8005\u3002',
    providers_remove: '\u79fb\u9664',
    providers_removing: '\u79fb\u9664\u4e2d\u2026',
    providers_save: '\u5132\u5b58',
    ...
    status_profile: '個人資料',
    status_hermes_home: 'JarvisCopilot 主目錄',
    status_started: '開始時間',
    status_tokens: 'Token',
    status_updated: '已更新',
  ...
  pt: {
    ...
    offline_network_detail: 'O JarvisCopilot está inacessível neste navegador agora.',
    offline_autorefresh: 'Vou atualizar esta página automaticamente quando o JarvisCopilot voltar a responder.',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" pode não funcionar com seu provedor configurado (${p}). Enviar assim mesmo, ou execute \`jarviscopilot model\` no terminal para trocar.`,
    ...
    cmd_skills: 'Listar skills disponíveis do JarvisCopilot',
    ...
    status_hermes_home: 'Diretório JarvisCopilot',
    ...
    no_personalities: 'Nenhuma personalidade encontrada (adicione em ~/.jarviscopilot/personalities/)',
    ...
    settings_section_preferences_meta: 'Padrões e comportamento UI do JarvisCopilot Web UI.',
    settings_section_system_title: 'Sistema',
    ...
    kanban_assignee_profiles_label: 'Perfis JarvisCopilot',
    ...
    tab_dashboard: 'Painel JarvisCopilot',
    ...
    settings_desc_whats_new_summary: "Changes the What's New action from opening the raw diff first to generating a short, human-readable summary. The regular diff comparison stays available after the summary.",
    settings_desc_bot_name: 'Nome de exibição do assistente. Padrão: JarvisCopilot.',
    ...
    providers_oauth_config_yaml_hint: 'Token configurado via config.yaml. Para atualizar, edite config.yaml ou rode jarviscopilot auth.',
    providers_oauth_not_configured_hint: 'Não autenticado. Rode jarviscopilot auth no terminal.',
    ...
    onboarding_title: 'Bem-vindo ao JarvisCopilot Web UI',
    onboarding_lead: 'Uma configuração rápida vai verificar JarvisCopilot, salvar provedor, escolher workspace e modelo, e opcionalmente proteger com senha.',
    ...
    onboarding_step_system_desc: 'Verificar JarvisCopilot Agent e visibilidade da config.',
    onboarding_step_setup_title: 'Configuração do provedor',
    onboarding_step_setup_desc: 'Salvar config mínima do provedor JarvisCopilot.',
    ...
    onboarding_notice_system_ready: 'JarvisCopilot Agent parece acessível pela Web UI.',
    onboarding_notice_system_unavailable: 'JarvisCopilot Agent não está totalmente disponível. Bootstrap pode instalar, mas setup do provedor pode requerer terminal.',
    onboarding_check_agent: 'JarvisCopilot Agent',
    ...
    onboarding_notice_setup_required: 'Escolha caminho simples de provedor aqui. OAuth avançado ainda pertence ao JarvisCopilot CLI.',
    onboarding_notice_setup_already_ready: 'Setup de provedor JarvisCopilot já detectado. Pode manter ou substituir.',
    ...
    onboarding_oauth_provider_not_ready_body: 'Esta instância usa <strong>{provider}</strong> com OAuth. Rode `jarviscopilot auth` no terminal.',
    ...
    onboarding_api_key_placeholder_optional: 'Leave blank for keyless servers', // TODO: translate
    onboarding_api_key_help_keyless: 'Most LM Studio / Ollama / vLLM installs run keyless — leave this blank if your server doesn\'t require authentication. Use the Test connection button to verify.', // TODO: translate
    onboarding_api_key_help_prefix: 'Salvo como segredo no .env do JarvisCopilot usando',
    onboarding_base_url_label: 'Base URL',
    ...
    onboarding_workspace_help: 'Escolha modelo que JarvisCopilot deve usar para novos chats.',
  ...
  ko: {
    ...
    offline_network_detail: '현재 이 브라우저에서 JarvisCopilot에 연결할 수 없습니다.',
    offline_autorefresh: 'JarvisCopilot에 다시 연결되면 이 페이지를 자동으로 새로고침합니다.',
    ...
    status_profile: '프로필',
    status_hermes_home: 'JarvisCopilot 홈',
    ...
    settings_section_preferences_meta: 'JarvisCopilot Web UI의 기본값과 UI 동작.',
    ...
    kanban_assignee_profiles_label: 'JarvisCopilot 프로필',
    ...
    tab_todos: 'Todos',
    tab_insights: '통계',
    tab_dashboard: 'JarvisCopilot 대시보드',
    ...
    onboarding_lead: '간단한 안내 설정으로 JarvisCopilot 설치를 확인하고, 워크스페이스와 모델을 선택하며, 필요하면 비밀번호로 앱을 보호합니다.',
    onboarding_back: '뒤로',
  ...
  fr: {
    ...
    offline_network_detail: 'JarvisCopilot est actuellement inaccessible depuis ce navigateur.',
    ...
    mcp_restart_hint: 'Les modifications apportées au serveur sont en lecture seule ici pour le moment. Modifiez config.yaml et redémarrez JarvisCopilot pour que les modifications prennent effet.',
    ...
    no_personalities: 'Aucune personnalité trouvée (ajoutez-les à ~/.jarviscopilot/personalities/)',
    ...
    settings_section_preferences_meta: 'Paramètres par défaut et comportement de l\'interface utilisateur pour JarvisCopilot Web UI.',
    ...
    kanban_work_queue_hint: 'Il s\'agit de la file d\'attente de travail de l\'agent JarvisCopilot. Créez ou triez une tâche, attribuez-la, déplacez-la vers Prêt, puis laissez le répartiteur la réclamer.',
    ...
    settings_desc_sync_insights: 'Met en miroir l\'utilisation du jeton WebUI dans state.db afin que JarvisCopilot /insights inclut les données de session du navigateur. Désactivé par défaut.',
    ...
    providers_oauth_config_yaml_hint: 'Jeton configuré via config.yaml. Pour mettre à jour, modifiez la section des fournisseurs dans votre config.yaml ou exécutez JarvisCopilot Auth.',
    providers_oauth_not_configured_hint: 'Non authentifié. Exécutez JarvisCopilot Auth dans le terminal pour configurer ce fournisseur.',
    ...
    onboarding_lead: 'Une configuration guidée rapide vérifiera JarvisCopilot, enregistrera une configuration réelle du fournisseur, choisira un espace de travail et un modèle et protégera éventuellement l\'application avec un mot de passe.',
    onboarding_back: 'Dos',
    ...
    onboarding_step_system_desc: 'Vérifiez la visibilité de l\'agent JarvisCopilot et de la configuration.',
    onboarding_step_setup_title: 'Configuration du fournisseur',
    onboarding_step_setup_desc: 'Enregistrez la configuration minimale du fournisseur JarvisCopilot.',
    ...
    onboarding_notice_system_ready: 'L\'agent JarvisCopilot semble accessible depuis l\'interface utilisateur Web.',
    onboarding_notice_system_unavailable: 'JarvisCopilot Agent n’est pas encore entièrement disponible. Bootstrap peut l\'installer, mais la configuration du fournisseur peut toujours nécessiter un terminal.',
    ...
    onboarding_notice_setup_required: 'Choisissez ici un chemin de fournisseur simple. Les flux OAuth avancés appartiennent toujours à la CLI JarvisCopilot pour le moment.',
    onboarding_notice_setup_already_ready: 'Une configuration de fournisseur JarvisCopilot fonctionnelle est déjà détectée. Vous pouvez le conserver ou le remplacer ici.',
    onboarding_oauth_provider_ready_title: 'Fournisseur déjà authentifié',
    onboarding_oauth_provider_ready_body: 'Cette instance est configurée pour utiliser un fournisseur OAuth (<strong>{provider}</strong>) configuré via la CLI JarvisCopilot. Aucune clé API n\'est nécessaire ici - cliquez sur Continuer pour terminer la configuration.',
    onboarding_oauth_provider_not_ready_title: 'Fournisseur OAuth pas encore authentifié',
    onboarding_oauth_provider_not_ready_body: 'Cette instance est configurée pour utiliser <strong>{provider}</strong>, qui utilise OAuth plutôt qu\'une clé API. Exécutez <code>jarviscopilot auth</code> ou <code>jarviscopilot model</code> dans un terminal pour vous authentifier, puis rechargez l\'interface utilisateur Web.',
    ...
    onboarding_api_key_help_prefix: 'Enregistré comme secret dans votre fichier JarvisCopilot .env en utilisant',
    ...
    onboarding_workspace_help: 'Choisissez le modèle qu\'JarvisCopilot doit utiliser pour les nouvelles discussions une fois la configuration terminée.',
