...
def _load_hermes_env_vars() -> dict[str, str]:
    """Load ~/.jarviscopilot/.env values without failing Docker command execution."""
    try:
...
#   SETUID/SETGID - the image entrypoint drops from root to the 'jarviscopilot'
...
class DockerEnvironment(BaseEnvironment):
    ...
    def __init__(
        ...
        # (TERMINAL_SANDBOX_DIR, default ~/.jarviscopilot/sandboxes/). Non-persistent
    ...
    def _build_init_env_args(self) -> list[str]:
        ...
        # win over the generic JarvisCopilot secret blocklist. Only implicit passthrough
        # keys are filtered.
