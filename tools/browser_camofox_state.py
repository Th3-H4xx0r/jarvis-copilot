...
persistent browser profiles.  When managed persistence is enabled, JarvisCopilot
...
def get_camofox_identity(task_id: Optional[str] = None) -> Dict[str, str]:
    ...
    The user identity is profile-scoped (same JarvisCopilot profile = same userId).
