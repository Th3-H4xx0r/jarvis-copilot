...
Trust levels:
  - builtin:   Ships with JarvisCopilot. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.jarviscopilot/\.env|\~/\.jarviscopilot/\.env',
     "hermes_env_access", "critical", "exfiltration",
     "directly references JarvisCopilot secrets file"),
    ...
    (r'\.jarviscopilot/config\.yaml|\.jarviscopilot/SOUL\.md',
     "hermes_config_mod", "critical", "persistence",
     "references JarvisCopilot configuration files directly"),
