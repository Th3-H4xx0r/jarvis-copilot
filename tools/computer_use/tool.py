...
# regardless of approval level (e.g. logout kills the session JarvisCopilot runs in).
_BLOCKED_KEY_COMBOS = {
...
def handle_computer_use(args: Dict[str, Any], **kwargs) -> Any:
    ...
    try:
        ...
        return json.dumps({
            ...
            "hint": "Run `jarviscopilot tools` and enable Computer Use to install cua-driver.",
        })
