...
~/.jarviscopilot/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.jarviscopilot/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.jarviscopilot/skills/) first, then any
...
def _find_skill_in_other_profiles(name: str) -> List[Tuple[str, Path]]:
    """Look for ``name`` under SKILL.md across OTHER JarvisCopilot profiles.
    ...
    # Default profile (~/.jarviscopilot/skills) — only consider when active is non-default.
    ...
    # All named profiles (~/.jarviscopilot/profiles/*/skills)
