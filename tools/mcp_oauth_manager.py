...
`mcp_tool.py`, and `jarviscopilot_cli/mcp_config.py`. This module is the ONLY place
...
class MCPOAuthManager:
    ...
    def remove(self, server_name: str) -> None:
        ...
        Called by ``jarviscopilot mcp remove <name>`` and (indirectly) by
        ``jarviscopilot mcp login <name>`` during forced re-auth.
        """
        with self._entries_lock:
