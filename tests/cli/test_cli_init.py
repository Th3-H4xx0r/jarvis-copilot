...
class TestHistoryDisplay:
    ...
    def test_history_shows_recent_sessions_when_current_chat_is_empty(self, capsys):
        ...
        cli._session_db.list_sessions_rich.return_value = [
            ...
            },
            {
                ...
                "title": "Checking Running JarvisCopilot",
                "preview": "check running gateways for jarviscopilot agent",
                "last_active": 0,
            },
        ]
        ...
        assert "Checking Running JarvisCopilot" in output
    ...
    def test_sessions_with_target_delegates_to_resume(self):
        ...
        with patch.object(cli, "_handle_resume_command") as mock_resume:
            cli.process_command("/sessions Checking Running JarvisCopilot")

        mock_resume.assert_called_once_with(
            "/resume Checking Running JarvisCopilot"
        )
...
class TestRootLevelProviderOverride:
    ...
    def test_normalize_root_model_keys_moves_to_model(self):
        ...
        from jarviscopilot_cli.config import _normalize_root_model_keys
