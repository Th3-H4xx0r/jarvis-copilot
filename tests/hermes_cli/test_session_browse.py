"""Tests for the interactive session browser (`jarviscopilot sessions browse`).
...
from jarviscopilot_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """jarviscopilot sessions browse should be parseable."""
        from jarviscopilot_cli.main import main as _main_entry
