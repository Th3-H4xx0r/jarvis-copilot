...
The main() function in jarviscopilot_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `jarviscopilot -c model`
...
def _build_parser():
    """Build a minimal replica of the jarviscopilot top-level parser."""
