"""Tests for jarviscopilot_cli.web_server and related config utilities."""
...
class TestReloadEnv:
    ...
    def test_removes_deleted_known_vars(self, tmp_path):
        """reload_env() removes known JarvisCopilot vars not present in .env."""
        env_file = tmp_path / ".env"
    ...
    def test_does_not_remove_unknown_vars(self, tmp_path):
        """reload_env() preserves non-JarvisCopilot env vars even when absent from .env."""
        env_file = tmp_path / ".env"
        env_file.write_text("")
        with patch.dict(reload_env.__globals__, {"get_env_path": lambda: env_file}):
...
class TestWebServerEndpoints:
    ...
    def _setup_test_client(self, monkeypatch, _isolate_hermes_home):
        ...
        import jarviscopilot_state
        from jarviscopilot_constants import get_hermes_home
        from jarviscopilot_cli.web_server import app, _SESSION_HEADER_NAME, _SESSION_TOKEN

        monkeypatch.setattr(jarviscopilot_state, "DEFAULT_DB_PATH", get_hermes_home() / "state.db")
    ...
    def test_get_status_filters_unconfigured_gateway_platforms(self, monkeypatch):
        ...
        import jarviscopilot_cli.web_server as web_server
    ...
    def test_reveal_env_var(self, tmp_path):
        ...
        from jarviscopilot_cli.web_server import _SESSION_HEADER_NAME, _SESSION_TOKEN
    ...
    def test_reveal_env_var_no_token(self, tmp_path):
        ...
        from starlette.testclient import TestClient
        from jarviscopilot_cli.web_server import app
        from jarviscopilot_cli.config import save_env_value
    ...
    def test_reveal_env_var_bad_token(self, tmp_path):
        ...
        from jarviscopilot_cli.config import save_env_value
        from jarviscopilot_cli.web_server import _SESSION_HEADER_NAME
    ...
    def test_reveal_env_var_legacy_authorization_header_still_works(self, tmp_path):
        ...
        from jarviscopilot_cli.config import save_env_value
        from jarviscopilot_cli.web_server import _SESSION_TOKEN
    ...
    def test_path_traversal_dotdot_blocked(self):
        ...
        resp = self.client.get("/%2e%2e/jarviscopilot_cli/web_server.py")
        assert resp.status_code in {200, 404}
        if resp.status_code == 200:
...
class TestBuildSchemaFromConfig:
    def test_produces_expected_field_count(self):
        from jarviscopilot_cli.web_server import CONFIG_SCHEMA
    ...
    def test_empty_prefix_produces_correct_keys(self):
        from jarviscopilot_cli.web_server import _build_schema_from_config
...
class TestNewEndpoints:
    ...
    def test_profiles_list_falls_back_when_profile_listing_fails(self, monkeypatch):
        from jarviscopilot_constants import get_hermes_home
        import jarviscopilot_cli.profiles as profiles_mod
    ...
    def test_profile_setup_command_uses_hermes_for_default_profile(self):
        ...
        assert resp.status_code == 200
        assert resp.json()["command"] == "jarviscopilot setup"
    ...
    def test_skills_list_includes_disabled_skills(self, monkeypatch):
        ...
        import jarviscopilot_cli.skills_config as skills_config
        import jarviscopilot_cli.web_server as web_server
    ...
    def test_toolsets_list_matches_cli_enabled_state(self, monkeypatch):
        import jarviscopilot_cli.tools_config as tools_config
...
class TestModelContextLength:
    ...
    def test_normalize_extracts_context_length_from_dict(self):
        ...
        from jarviscopilot_cli.web_server import _normalize_config_for_web
    ...
    def test_denormalize_writes_context_length_into_model_dict(self):
        ...
        from jarviscopilot_cli.web_server import _denormalize_config_from_web
...
class TestModelInfoEndpoint:
    ...
    def test_model_info_with_dict_config(self, monkeypatch):
        import jarviscopilot_cli.web_server as ws
...
class TestNormaliseThemeDefinition:
    ...
    def test_rejects_missing_name(self):
        from jarviscopilot_cli.web_server import _normalise_theme_definition
...
class TestDiscoverUserThemes:
    """Tests for _discover_user_themes() — scans ~/.jarviscopilot/dashboard-themes/."""

    def test_returns_empty_when_dir_missing(self, tmp_path, monkeypatch):
        monkeypatch.setenv("HERMES_HOME", str(tmp_path))
        from jarviscopilot_cli import web_server
...
# or ``sh -c 'printf …'``) instead of the real ``jarviscopilot --tui`` binary.  The
...
class TestPtyWebSocket:
    ...
    def test_resolve_chat_argv_uses_dashboard_scroll_env(self, monkeypatch):
        ...
        import jarviscopilot_cli.main as main_mod
    ...
    def test_unavailable_platform_closes_with_message(self, monkeypatch):
        from jarviscopilot_cli.pty_bridge import PtyUnavailableError
        ...
        import jarviscopilot_cli.web_server as ws_mod
    ...
    def test_pub_broadcasts_to_events_subscribers(self, monkeypatch):
        ...
        import time
        from urllib.parse import urlencode
        from jarviscopilot_cli import web_server as ws_mod
