...
class TestBuildOrHeaders:
    ...
    def test_base_attribution_always_present(self):
        ...
        assert headers["HTTP-Referer"] == "https://jarviscopilot.nousresearch.com"
        assert headers["X-Title"] == "JarvisCopilot"
    ...
    def test_none_config_falls_back_to_load_config(self):
        ...
        with patch("jarviscopilot_cli.config.load_config", return_value=fake_cfg):
