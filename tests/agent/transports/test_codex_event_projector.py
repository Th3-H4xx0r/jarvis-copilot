"""Tests for CodexEventProjector — codex item/* events → JarvisCopilot messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks JarvisCopilot' message alternation invariant."""
