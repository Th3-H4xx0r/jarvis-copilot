...
def hermes_home(tmp_path, monkeypatch):
    """Point JarvisCopilot at an isolated home directory."""
    ...
    if hasattr(jarviscopilot_constants, "_HERMES_HOME_CACHE"):
        jarviscopilot_constants._HERMES_HOME_CACHE = None  # type: ignore[attr-defined]
    return home
...
def test_env_loader_skips_when_disabled(tmp_path, monkeypatch):
    ...
    from jarviscopilot_cli.env_loader import _apply_external_secret_sources
