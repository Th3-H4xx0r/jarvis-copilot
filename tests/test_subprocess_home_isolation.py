...
See: https://github.com/NousResearch/jarviscopilot/issues/4426
"""
...
class TestGetSubprocessHome:
    """Unit tests for jarviscopilot_constants.get_subprocess_home()."""
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        base = tmp_path / ".jarviscopilot" / "profiles"
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from jarviscopilot_cli.profiles import _PROFILE_DIRS
