...
class TestHermesHomeIsolation:
    def test_hermes_bin_dir_respects_hermes_home(self):
        """_hermes_bin_dir must use HERMES_HOME, not hardcoded ~/.jarviscopilot."""
    ...
    def test_failure_marker_respects_hermes_home(self):
        """_failure_marker_path must use HERMES_HOME, not hardcoded ~/.jarviscopilot."""
    ...
    def test_get_hermes_home_fallback(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            expected = os.path.join(os.path.expanduser("~"), ".jarviscopilot")
