...
misrouted or handed JarvisCopilot secrets.

See: https://github.com/NousResearch/jarviscopilot/issues/1002
See: https://github.com/NousResearch/jarviscopilot/issues/1264
"""
...
class TestProviderEnvBlocklist:
    """Provider env vars loaded from ~/.jarviscopilot/.env must not leak."""
