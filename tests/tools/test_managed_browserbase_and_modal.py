...
def _enable_managed_nous_tools(monkeypatch):
    ...
    jarviscopilot_cli.auth and jarviscopilot_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("jarviscopilot_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("jarviscopilot_cli.models.check_nous_free_tier", lambda: False)
