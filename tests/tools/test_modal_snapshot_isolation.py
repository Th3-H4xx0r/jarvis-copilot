...
def _restore_tool_modules():
    ...
    original_modules = {
        ...
        or name == "jarviscopilot_cli"
        or name.startswith("jarviscopilot_cli.")
        or name == "modal"
    ...
    try:
        ...
        _reset_modules(("tools", "jarviscopilot_cli", "modal"))
...
def _install_modal_test_modules(
    ...
    *,
    ...
    jarviscopilot_cli.__path__ = []  # type: ignore[attr-defined]
    sys.modules["jarviscopilot_cli"] = jarviscopilot_cli
    hermes_home = tmp_path / "hermes-home"
    os.environ["HERMES_HOME"] = str(hermes_home)
    sys.modules["jarviscopilot_cli.config"] = types.SimpleNamespace(
    ...
    async def _lookup_aio(_name: str, create_if_missing: bool = False):
        return types.SimpleNamespace(name="jarviscopilot", create_if_missing=create_if_missing)
