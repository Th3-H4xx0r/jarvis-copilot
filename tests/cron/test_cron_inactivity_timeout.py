...
class TestSysPathOrdering:
    ...
    def test_jarviscopilot_time_importable(self):
        """jarviscopilot_time should be importable when cron.scheduler loads."""
    ...
    def test_jarviscopilot_constants_importable(self):
        """jarviscopilot_constants should be importable from cron context."""
