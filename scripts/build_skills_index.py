#!/usr/bin/env python3
"""Build the JarvisCopilot Skills Index — a centralized JSON catalog of all skills.
...
`jarviscopilot skills search/install` can use it without hitting the GitHub API.
...
def main():
    print("Building JarvisCopilot Skills Index...", flush=True)
