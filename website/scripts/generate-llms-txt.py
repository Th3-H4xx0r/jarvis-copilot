#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the JarvisCopilot docs site.
...
Both publish at:
  https://jarviscopilot.nousresearch.com/docs/llms.txt
  https://jarviscopilot.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://jarviscopilot.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use JarvisCopilot as a Python Library", None),
        ("guides/use-mcp-with-hermes", "Use MCP with JarvisCopilot", None),
        ("guides/use-voice-mode-with-hermes", "Use Voice Mode with JarvisCopilot", None),
        ("guides/use-soul-with-hermes", "Use SOUL.md with JarvisCopilot", None),
        ("guides/build-a-hermes-plugin", "Build a JarvisCopilot Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with JarvisCopilot"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "jarviscopilot/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/jarviscopilot")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# JarvisCopilot — Full Documentation\n",
        (
            "This file is the entire JarvisCopilot documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using JarvisCopilot, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://jarviscopilot.nousresearch.com/docs\n",
        "Short index: https://jarviscopilot.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
