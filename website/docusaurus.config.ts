...
const config: Config = {
  title: 'JarvisCopilot Agent',
  tagline: 'The self-improving AI agent',
  favicon: 'img/favicon.ico',

  url: 'https://jarviscopilot.nousresearch.com',
  baseUrl: '/docs/',

  organizationName: 'NousResearch',
  projectName: 'jarviscopilot',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/NousResearch/jarviscopilot/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/jarviscopilot-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://jarviscopilot.nousresearch.com',
          label: 'Home',
          position: 'right',
        },
        {
          href: 'https://github.com/NousResearch/jarviscopilot',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Discussions', href: 'https://github.com/NousResearch/jarviscopilot/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'https://github.com/NousResearch/jarviscopilot' },
