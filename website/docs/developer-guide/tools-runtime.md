...
JarvisCopilot tools are self-registering functions grouped into toolsets and executed through a central registry/dispatch system.
...
Toolsets are named bundles of tools. JarvisCopilot resolves them through:

- explicit enabled/disabled toolset lists
- platform presets (`jarviscopilot-cli`, `jarviscopilot-telegram`, etc.)
- dynamic MCP toolsets
- curated special-purpose sets like `jarviscopilot-acp`
