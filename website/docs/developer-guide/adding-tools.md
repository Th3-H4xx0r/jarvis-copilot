...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to JarvisCopilot — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in JarvisCopilot tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying JarvisCopilot core, use the plugin route instead:

- [Plugins](/docs/user-guide/features/plugins)
- [Build a JarvisCopilot Plugin](/docs/guides/build-a-hermes-plugin)
...
- [ ] Tested with `jarviscopilot chat -q "Use the weather tool for London"`
