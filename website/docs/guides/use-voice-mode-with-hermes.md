---
sidebar_position: 8
title: "Use Voice Mode with JarvisCopilot"
description: "A practical guide to setting up and using JarvisCopilot voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with JarvisCopilot
...
- you want JarvisCopilot sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in JarvisCopilot.
...
## Step 1: make sure normal JarvisCopilot works first

Before touching voice mode, verify that:
- JarvisCopilot starts
...
JarvisCopilot supports both local and cloud speech stacks.
...
4. JarvisCopilot transcribes and responds
...
- asking JarvisCopilot to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full JarvisCopilot loop.

## Tuning CLI behavior

### Silence threshold

If JarvisCopilot starts/stops too aggressively, tune:
...
JarvisCopilot stays a normal chat bot, but can speak replies.
...
- you want JarvisCopilot to function like a portable research or ops assistant
...
JarvisCopilot joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- JarvisCopilot detects speech boundaries
- transcripts are posted in the associated text channel
- JarvisCopilot responds in text and audio
...
1. get text JarvisCopilot working
2. install `jarviscopilot[voice]`
