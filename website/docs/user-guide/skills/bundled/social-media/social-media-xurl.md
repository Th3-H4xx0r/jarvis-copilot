...
| Version | `1.1.1` |
| Author | xdevplatform + openclaw + JarvisCopilot |
| License | MIT |
...
- JarvisCopilot adaptation: reformatted for JarvisCopilot skill conventions; safety guardrails preserved verbatim.
