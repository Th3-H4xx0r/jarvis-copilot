...
```python
import sys
sys.path.insert(0, "/home/teknium/.jarviscopilot/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.jarviscopilot/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — JarvisCopilot installs package this)
