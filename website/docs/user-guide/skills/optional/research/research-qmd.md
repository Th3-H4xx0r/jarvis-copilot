...
| | |
|---|---|
| Source | Optional — install with `jarviscopilot skills install official/research/qmd` |
...
JarvisCopilot via the native MCP client. This is the preferred
...
Then configure JarvisCopilot to connect via HTTP:
