...
| | |
|---|---|
| Source | Optional — install with `jarviscopilot skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), JarvisCopilot |
| License | MIT |
...
import upstream classes into JarvisCopilot itself.
...
```bash
mkdir -p ~/.jarviscopilot/cache/darwinian-evolver && cd ~/.jarviscopilot/cache/darwinian-evolver
...
```bash
cd ~/.jarviscopilot/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.jarviscopilot/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.jarviscopilot/skills/research/darwinian-evolver
DE_DIR=~/.jarviscopilot/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside JarvisCopilot core.
   Custom driver scripts under `~/.jarviscopilot/skills/...` are user-side and fine.
