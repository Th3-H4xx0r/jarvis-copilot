...
- User wants **JarvisCopilot itself to drive a browser** → use JarvisCopilot' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
