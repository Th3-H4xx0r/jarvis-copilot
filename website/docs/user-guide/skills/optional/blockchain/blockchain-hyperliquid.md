...
| | |
|---|---|
| Source | Optional — install with `jarviscopilot skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), JarvisCopilot |
| License | MIT |
...
The script reads `~/.jarviscopilot/.env` for two optional defaults:
...
Helper script: `~/.jarviscopilot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.jarviscopilot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.jarviscopilot/.env`.
...
```bash
python3 ~/.jarviscopilot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.jarviscopilot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
