...
| | |
|---|---|
| Source | Optional — install with `jarviscopilot skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), JarvisCopilot |
| License | MIT |
...
Helper script path: `~/.jarviscopilot/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.jarviscopilot/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.jarviscopilot/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.jarviscopilot/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
