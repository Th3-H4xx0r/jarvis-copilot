...
| | |
|---|---|
| Source | Optional — install with `jarviscopilot skills install official/health/neuroskill-bci` |
...
Connect JarvisCopilot to a running [NeuroSkill](https://neuroskill.com/) instance to read
