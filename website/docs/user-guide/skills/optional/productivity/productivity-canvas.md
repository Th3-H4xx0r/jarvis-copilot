...
| | |
|---|---|
| Source | Optional — install with `jarviscopilot skills install official/productivity/canvas` |
...
4. Name the token (e.g., "JarvisCopilot"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.jarviscopilot/.env`:
