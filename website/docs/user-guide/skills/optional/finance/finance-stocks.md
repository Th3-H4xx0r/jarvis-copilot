...
| | |
|---|---|
| Source | Optional — install with `jarviscopilot skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), JarvisCopilot |
| License | MIT |
...
```
SCRIPT=~/.jarviscopilot/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.jarviscopilot/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
