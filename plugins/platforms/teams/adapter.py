"""
Microsoft Teams platform adapter for JarvisCopilot.
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            self._app = App(
                ...
                client=ClientOptions(headers={"User-Agent": "JarvisCopilot"}),
            )
...
def interactive_setup() -> None:
    ...
    print_info("  teams app create --name \"JarvisCopilot\" --endpoint \"https://<tunnel>/api/messages\"")
    print()
    ...
    print()
    print_success("Teams configuration saved to ~/.jarviscopilot/.env")
