"""ntfy platform adapter (JarvisCopilot plugin).
...
a JarvisCopilot dependency.

This adapter ships as a JarvisCopilot platform plugin under
``plugins/platforms/ntfy/``. The JarvisCopilot plugin loader scans the
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a JarvisCopilot dependency",
