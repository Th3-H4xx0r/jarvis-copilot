# JarvisCopilot Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.jarviscopilot/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.jarviscopilot/plugins/hermes-achievements/scan_checkpoint.json`.
